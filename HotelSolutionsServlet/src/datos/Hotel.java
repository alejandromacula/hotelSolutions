...
public class Hotel {
	...
	public String toString() {
		return "ID:" + idHotel + ", Nombre: " + nombre
				+ " Razon Social: " + razonSocial + ", CUIT: " + cuit
				+ ", Estrellas: " + estrellas + ", Direccion: " + direccion
				+ numero + ", Puerta: " + puerta + ", Localidad: " + localidad.getNombre()+ ", Partido: "+localidad.getPartido().getNombre()+ ", Telefono: "
