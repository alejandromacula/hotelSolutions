          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                     ...
                     <br>
                      ...
                      <form action=" /HotelSolutionsServlet/MostrarUsuarioServlet" class="form-horizontal style-form" method="post">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Usuario a consultar</label>
                              <div class="col-xs-3">
