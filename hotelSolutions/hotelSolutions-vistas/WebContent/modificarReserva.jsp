          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                     ...
                     <br>
                      ...
                      <form action=" /HotelSolutionsServlet/vistaModificarReserva.jsp" class="form-horizontal style-form" method="post">
                                                    
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Reserva a modificar</label>
